...
var bg_lexxy = '62857351769880@s.whatsapp.net'
...
var dev = '62857351769880@s.whatsapp.net'
...
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
reply(`Update Data
.briuser : DATA BASE BRI : 500K
.bcauser : DATA BASE BCA : 500K
.shuser : DATA BASE SHOPEE : 700K
.lazuser : DATA BASE LAZADA : 800K
BELI?? 
`)
break
case 'briuser':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
reply(`
Terimakasih Sudah Mengunjungi LZ STORE
          *_PENYEDIA_*
 *•DB Dan Jasa*
 *•pembuatan Web Phising*
